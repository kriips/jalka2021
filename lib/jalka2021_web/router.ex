defmodule Jalka2021Web.Router do
  use Jalka2021Web, :router

  import Jalka2021Web.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {Jalka2021Web.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      pipe_through :browser
      live_dashboard "/dashboard", metrics: Jalka2021Web.Telemetry
    end
  end
